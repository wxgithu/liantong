            ...
            <div class="center ">
                ...
                <div class="left-side float-left" >
                    ...
                    <ul class="sidebar_nav list-unstyled mt-2">
                        <li><router-link to="/customer/loginmyorder" class="myorder" >我的订单</router-link></li>
                    ...
                    <h2 class="">我的账户</h2>
                    <ul class="sidebar_nav list-unstyled mt-2">
                        <li><router-link to="/customer/personalInfo" class="personinfo" >个人信息</router-link></li>
                        <li><router-link to="/customer/pwdUpdate" class="updatePwd">密码修改</router-link></li>
                        <li><a href="#" >账号绑定</a></li>
                        <li><a href="#" >号码管理</a></li>
                        <li><router-link to="/customer/receiveAddress" class="address">收货地址</router-link></li>
